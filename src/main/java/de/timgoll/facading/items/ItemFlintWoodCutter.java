...
public class ItemFlintWoodCutter extends Item implements IHasModel {

    public ItemFlintWoodCutter(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
        ...
        String tooltip_text = new TextComponentTranslation("tooltip.flintwoodcutter.text").getFormattedText();
