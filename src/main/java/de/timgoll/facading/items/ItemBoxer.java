...
public class ItemBoxer extends Item implements IHasModel {

    public ItemBoxer(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
        ...
        String tooltip_text = new TextComponentTranslation("tooltip.boxer.text").getFormattedText();
