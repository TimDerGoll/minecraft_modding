package de.timgoll.facadingIndustry.init;

import java.util.ArrayList;
import java.util.List;

import de.timgoll.facadingIndustry.FacadingIndustry;
import de.timgoll.facadingIndustry.blocks.*;
import de.timgoll.facadingIndustry.items.*;
import de.timgoll.facadingIndustry.sounds.SoundHandler;
...
public class ModRegistry {
	...
	public static final CreativeTabs TAB = new CreativeTabs(FacadingIndustry.MODID) {
