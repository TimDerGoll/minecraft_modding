package de.timgoll.facadingIndustry.client.gui.buttons;
...
public class ButtonMachine extends GuiButton {
    final ResourceLocation texture;
    private int x, y, textureX, textureY, textureX_hover, textureY_hover, textureX_enable, textureY_enable;

    public ButtonMachine(int buttonId, int x, int y, int textureX, int textureY, int textureX_hover, int textureY_hover, int textureX_enable, int textureY_enable, int width, int height, String resourcePath) {
        ...
        texture = new ResourceLocation(FacadingIndustry.MODID, resourcePath);
    }
