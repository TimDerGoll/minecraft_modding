...
import de.timgoll.facadingIndustry.client.gui.buttons.ButtonMachinePreview;
import de.timgoll.facadingIndustry.client.gui.buttons.ButtonMachineSquare;
import de.timgoll.facadingIndustry.container.ContainerMachineBase;
import de.timgoll.facadingIndustry.network.PacketHandler;
import de.timgoll.facadingIndustry.network.facadingbench.PacketGuiAddProductionRequest;
import de.timgoll.facadingIndustry.network.facadingbench.PacketGuiCancelProductionRequest;
import de.timgoll.facadingIndustry.network.facadingbench.PacketGuiOpenedRequest;
...
public class GuiMachineBase extends GuiContainer {
    ...
    private static final ResourceLocation texture = new ResourceLocation(FacadingIndustry.MODID, "textures/gui/machinefacadingbench.png");
