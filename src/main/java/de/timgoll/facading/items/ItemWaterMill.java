...
public class ItemWaterMill extends Item implements IHasModel {

    public ItemWaterMill(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
        ...
        String tooltip_text = new TextComponentTranslation("tooltip.watermill.text").getFormattedText();
